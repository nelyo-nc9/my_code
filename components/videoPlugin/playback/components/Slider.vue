...
.bsr-slider-horizontal-wrap-button {
  border-radius: 50%;
  border: 0;
  background-image: -webkit-linear-gradient(90deg, rgb(112, 144, 197) 0%, rgb(131, 162, 213) 100%);
  background-image: -ms-linear-gradient(90deg, rgb(112, 144, 197) 0%, rgb(131, 162, 213) 100%);
  background-image: linear-gradient(90deg, rgb(112, 144, 197) 0%, rgb(131, 162, 213) 100%);
  box-shadow: 0px 3px 5px 0px rgba(24, 43, 76, 0.004), inset 0px 1px 0px 0px rgba(188, 211, 248, 0.004),
