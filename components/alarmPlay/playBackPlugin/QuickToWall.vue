  ...
  <div class="wall">
    ...
    >
      ...
      >
        <div
          class="channel"
          :class="{alarm: info.type === 2 || !info.use, checked: checkedIndex === i + '-' + index}"
          :style="{width: cwd(info.panecount), height: cht(info.panecount)}"
          v-for="index in info.panecount"
          :key="info._id+index"
