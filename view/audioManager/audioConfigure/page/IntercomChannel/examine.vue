...
<!-- 对讲通道关联配置列表  查看 -->
  <div id="viewRealted">
    ...
    <div class="top">
      ...
      <div class="header">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>音频配置</el-breadcrumb-item>
          <el-breadcrumb-item>对讲通道关联配置列表</el-breadcrumb-item>
    ...
    <div ref="printJS_container" class="print-container" id="printJS_container">
      <div class="tableView">
        <div class="tableList">
          <ul>
      ...
      <div class="box-big">
        <div class="bottom-box">
          <div style="width:100%;">
            <div class="form-title form-title1">
              <span class="title"
                    @click="dropdownStatus.detector1 = !dropdownStatus.detector1">摄像机列表</span>
              <i :class="!dropdownStatus.detector1 ? 'el-icon-arrow-up' : 'el-icon-arrow-down'"></i>
            </div>
            <div v-if="!dropdownStatus.detector1" style="width:100%;">
        ...
        <div class="bottom-box">
          <div style="width:100%;">
            <div class="form-title">
              <span class="title"
                    @click="dropdownStatus.detector2 = !dropdownStatus.detector2">对讲通道列表</span>
              <i :class="!dropdownStatus.detector2 ? 'el-icon-arrow-up' : 'el-icon-arrow-down'"></i>
            </div>
            <div v-if="!dropdownStatus.detector2" style="width:100%;">
        ...
        <div class="bottom-box">
          <div style="width:100%;">
            ...
            <div v-if="!dropdownStatus.detector3" style="width:100%;">
        ...
        <div class="bottom-box">
          <div style="width:100%;">
            ...
            <div v-if="!dropdownStatus.detector4" style="width:100%;">
  ...
  data() {
    return {
      ...
      tableView: [
        ...
        { title: '所属设备', context: this.hostInfo.deviceName },
        { title: '对讲通道名称', context: this.hostInfo.name },
      ],
    }
  },
  methods: {
