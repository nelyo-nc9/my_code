...
export default {
  ...
  watch: {
    ...
    // '$store.state.map2d.mapIndex.drawDistrictStyle'(newValue, oldValue) {
    //   console.log('1112')
    //   this.spaceForm = (newValue)
  ...
  computed: {
    ...mapState({
      ...
      selectDistrictName: ({ map2d }) => map2d.mapIndex.selectDistrictName,
  ...
  methods: {
    ...
    getDistrictStyle() {
      ...
      //   adcode: this.nowSelectAreaInfo.adcode
      // }
      // this.getDistrictSetting(data)
      this.spaceForm = cloneDeep(this.drawDistrictStyle)
      // console.log(this.$store.state.map2d)
    },
    cancel() {
      this.setPanelInfoStatus(false)
      // this.$emit('closeSetting', false)
