    ...
    <div class="organization-info">
      <div class="organize-info-readonly">
        <table style="border-collapse:collapse;">
          <tr>
            <td>设备名称</td>
            <td>{{ equipmentForm.name }}</td>
          </tr>
          <tr>
            <td>IP地址</td>
            <td>
              <span>{{ equipmentForm.ipAddress }}</span
              ><el-button type="primary" size="mini" style="float: right;">ping</el-button>
            </td>
          </tr>
          <tr>
            <td>设备类型</td>
            <td>{{ equipmentForm.type }}</td>
          </tr>
          <tr>
            <td>品牌</td>
            <td>{{ equipmentForm.brand }}</td>
          </tr>
          <tr>
            <td>型号</td>
            <td>{{ equipmentForm.model }}</td>
          </tr>
          <tr>
            <td>所属子系统</td>
            <td>{{ equipmentForm.subsystem }}</td>
          </tr>
          <tr>
            <td>所属重点部位</td>
            <td>{{ equipmentForm.importPart }}</td>
          </tr>
          <tr>
            <td>所属机构</td>
            <td>{{ equipmentForm.organization }}</td>
          </tr>
          <tr>
            <td>状态</td>
            <td>{{ equipmentForm.status }}</td>
          </tr>
        </table>
      </div>
      <!-- 取消，保存 -->
