<template>
  <div class="video-host-relate-box">
     <!-- 中间树 -->
    ...
    <div class="content">
      <other-list :tierType="tierType" :orgId="currentOrgId" :deviceId="deviceId" :keyPartId="currentKeyPartId" @changeComponent="changeComponent" @changeOrgId="changeOrgId" @changeSelect="changeSelect" @viewLink="viewLink"></other-list>
    </div>
  </div>
</template>
