...
export default {
  ...
  methods: {
    ...
    getRecordType(obj) {
      ...
      let rType = obj.recordType || obj.eventType
      if (rType) {
        if (rType === 'timeRecord' || rType === 200 || rType === 1) {
          return timedVideo
        } else if (rType === 'timeVideo' || rType === 3) {
          return timedVideo
        } else if (rType === 'eventRecord' || rType === 4) {
          return 1
        } else if (rType === 'manualRecord' || rType === 201 || rType === 2) {
          return manualVideo
        } else if (rType === 9001) {
          return tagVideo
        } else {
