 ...
 * @LastEditTime: 2020-06-17 10:41:55
    ...
    <div class="right-content">
      ...
      <div class="top-box">
        ...
        <div class="button-box"
          ...
          <el-button size="mini" @click="dialogVisibleBtn">删除</el-button>
...
import { getParkConfigApi, updateParkConfigApi, addParkConfigApi, deleteParkConfigApi } from '@src/http/parkingManage/parkingRecord.api.js'
export default {
  name: 'emphasis',
  components: {
    parkPaging,
  ...
  data() {
    return {
      ...
      tableColumn: [
        ...
        { prop: 'type', sortable: true, label: '车辆型号', width: '' },
  ...
  methods: {
    ...
    getParkblacklistQuery() {
      let params = {
        limit: this.paginationConfig.limit,
        page: this.paginationConfig.page,
        type: this.paginationConfig.type,
        licensePlate: this.paginationConfig.licensePlate
      }
      getParkConfigApi(params).then((res) => {
