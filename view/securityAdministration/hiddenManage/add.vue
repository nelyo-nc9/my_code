  ...
  <div class="content">
    ...
    <div class="right-content">
      ...
      <div class="form-box">
        ...
        <div class="form-title">安全检查结果单</div>
        <div class="form-content">
          ...
          <div class="right-form">
            ...
            <el-form-item label="检查人员"                          
                            class="maBottom">
                <el-input v-model="formDataCopy.checkName"
                          ></el-input>
              </el-form-item>
               <el-form-item label="被检机构负责人"                          
                            class="maBottom">
                <el-input v-model="formDataCopy.organPerson"
                          ></el-input>
              </el-form-item>
                <el-form-item label="附件"                          
                            class="maBottom">
                <el-input v-model="formDataCopy.file"
                          ></el-input>
              </el-form-item>
        </div>
