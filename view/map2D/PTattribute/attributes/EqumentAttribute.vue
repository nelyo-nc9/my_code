    ...
    <div class="organization-info">
      <div class="organize-info-readonly">
        <table style="border-collapse:collapse;">
          ...
          <tr><td>通道号</td><td>  <span class="value" v-if=" curSelectResourcePoint.resource.serise">{{ curSelectResourcePoint.resource.serise }}</span><el-button type="primary" size="mini" style="float: right;">ping</el-button></td></tr>
