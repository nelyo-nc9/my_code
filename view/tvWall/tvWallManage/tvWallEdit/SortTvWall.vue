 ...
 * @LastEditTime: 2020-07-19 14:24:43
 * @Description: In User Settings Edit
 * @FilePath: \CCB\client\src\view\tvWall\tvWallManage\tvWallEdit\SortTvWall.vue
-->
<template>
  <div class="main">
    <div class="left-tree">
    ...
    <div class="right-content">
      ...
      <div class="main-content">
        <div style="margin: 10px 0;">电视墙列表信息</div>
...
export default {
  ...
  methods: {
    ...
    ...mapActions(['getTvWallListApi', 'sortTvWallListApi']),
    cancel() {
    ...
    swapItems(arr, index1, index2, direction) {
      ...
      let temp = ''
      temp = arr[index1].serialCode
      arr[index1].serialCode = arr[index2].serialCode
      arr[index2].serialCode = temp
      temp = ''
      console.log(arr, index1, index2, '排序后要返回的数组')
      return arr
    },
    upIndex(index) {
      if (index === 0) {
    ...
    save() {
      ...
      this.sortTvWallListApi(tempData)
        .then(res => {
          if (res.data.code === 0) {
