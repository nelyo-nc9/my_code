...
<template>
    <div class="content">
        ...
        width="40%"
        center>
            <addPatrolTask ref="addPatrolTask"></addPatrolTask>
...
import addPatrolTask from './addPatrolTask'
      ...
      tableData: [
        {
          ...
          code: '二楼消防栓,灭火器',
          brand: '张三',
          deviceModel: '2020-05-12',
          netModuleBrand: '2020-05-12'
        },
        {
          orgName: '保定分行',
          keySite: '汇融支行营业网点',
