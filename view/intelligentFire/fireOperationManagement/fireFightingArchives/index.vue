<template>
  <div class="alarm-main">
    ...
    <div class="left-tabs" :style="{ width: isOpenPanel ? '220px' : '28px' }" v-if="!isNewFile">
...
import customizationFile from './customizationFile'
    ...
    return {
      tabs: [
        ...
        },
        {
          ...
          label: '巡检管理',
          items: [
            { index: 'path:patrolInspectionManagement:newlyPatrol', label: '新增巡检点' },
            { index: 'path:patrolInspectionManagement:patrolTask', label: '巡检任务管理' },
            { index: 'path:patrolInspectionManagement:patrolQuery', label: '巡检任务查询' }
          ]
        },
        {
          ...
          label: '消防档案',
          items: [
            { index: 'customizationFile', label: '自定义文件' },
            { index: 'filesDetail', label: '档案详情' },
            { index: 'editFileName', label: '编辑文件详情名称' }
          ]
        }
      ],
      isOpenPanel: true
