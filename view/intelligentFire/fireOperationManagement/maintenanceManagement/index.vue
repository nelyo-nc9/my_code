...
import maintenanceQuery from './maintenanceQuery'
...
export default {
    ...
    return {
      tabs: [
        ...
        },
        {
          ...
          label: '维保管理',
          items: [
            { index: 'maintenanceList', label: '维保任务管理' },
            { index: 'maintenanceQuery', label: '维保任务执行查询' }
          ]
        },
        {
  ...
  watch: {},
  created() {
    // this.SET_COMPONENT_ID('maintenanceList')
