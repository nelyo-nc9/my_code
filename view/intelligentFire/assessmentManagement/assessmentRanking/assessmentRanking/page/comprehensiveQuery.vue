      ...
      <div class="right-content">
          ...
          <div class="form-box">
              ...
              <div class="form-content" v-if="dropdownStatus.detector">
                  <div class="left-form">
                      <el-form ref="addForm" size="mini" :model="formData" label-position="right" :inline="true" label-width="120px">
                          ...
                          <el-form-item label="评分分值" required>
                              <el-input placeholder="请输入(固定分值)" v-model="formData.deviceName"></el-input>
                          </el-form-item>
              ...
              <div class="form-footer">
                  ...
                  <el-button size="mini" @click="">下载</el-button>
              </div>
          </div>
