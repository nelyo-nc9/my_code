      ...
      <div class="table-box">
        <div class="table-top">
          ...
          <el-input suffix-icon="el-icon-search"
                    ...
                    size="mini"></el-input>
          <el-select style="float:right;width:170px;margin-right:12px;"
                     v-model="status"
                     size="mini">
            <el-option :label="item.name"
                       :value="item.id"
                       v-for="(item,index) in selcetData"
                       :key="index"></el-option>
          </el-select>
        </div>
        <div style="flex:1;"
              ...
              <template slot-scope="scope">
                <div>
                  <el-link :underline="false"
                           @click="toUserAssistantChild(scope,'assessmentReports')">查看报告</el-link>
                  <el-link :underline="false"
                           @click="toUserAssistantChild(scope,'assessmentReport')">评估详细得分</el-link>
                </div>
              </template>
            </el-table-column>
          </el-table>
