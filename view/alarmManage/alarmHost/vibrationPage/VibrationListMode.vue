  ...
  <div class="host-list-mode">
    <div class="host-header">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>振动光纤报警主机</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="host-content-main"
      ...
      <div class="host-num">
        <ul>
          <li>振动光纤报警主机：<i @click="hostNumClick">{{total}}</i></li>
      ...
      <div class="host-table">
        <div class="table-select">
          <ul>
            ...
            <li class="table-select-btn">
              ...
              <el-button size="small"
                         @click="refreshClick">刷新</el-button>
            </li>
          </ul>
        </div>
        <div v-if="listMode"
        ...
        <div v-if="!listMode">
          <VibrationPanelMode :alarmHostList="tableData"
                              @backControlStatus="backControlStatus"
                              @handleLinkBtn="handleLinkBtn"
                              v-if="tableData.length"></VibrationPanelMode>
          <div v-else
    ...
    <div class="host-content-main"
         v-if="!controlStatus">
      <VibrationBackControl :backData="backControlData"
                            @selectMode="selectMode"></VibrationBackControl>
    </div>
    <div class="dialog">
      <!-- 布撤防提示框 -->
...
import VibrationPanelMode from './VibrationPanelMode'
import VibrationBackControl from './VibrationBackControl'
import LinkControl from '../linkControl/LinkControl'
import { mapState, mapMutations, mapActions, mapGetters } from 'vuex'
export default {
  components: {
    VibrationPanelMode,
    VibrationBackControl,
    LinkControl
  },
  data() {
    return {
  ...
  methods: {
    ...
    handleCurrentChange(val) {
      console.log(`当前页: ${val}`)
      this.page = val
      this.getAlarmHostManageList({ deviceType: '振动光纤报警主机', pageSize: this.pageSize, pageNum: val })
    },
    // 旁路按钮
    bypassClick() {
