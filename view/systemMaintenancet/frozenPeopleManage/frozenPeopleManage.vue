...
import FrozenPeopleManageList from './pages/FrozenPeopleManageList'
import FrozenPeopleManageSearch from './pages/FrozenPeopleManageSearch'

export default {
  name: 'frozenPeopleManage',
  components: {
    FrozenPeopleManageList,
    FrozenPeopleManageSearch
  },
  data() {
    return {
      ...
      menus: [
        {
          index: 'FrozenPeopleManage',
          title: '冻结用户管理',
          items: [
            {
              index: 'FrozenPeopleManageList',
              title: '列表'
            },
            {
              index: 'FrozenPeopleManageSearch',
              title: '查询'
            }
          ]
        }
