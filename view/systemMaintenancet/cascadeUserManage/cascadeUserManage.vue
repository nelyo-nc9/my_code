<template>
  <div class="cascadeUser-manage-box">
    <!-- 左侧导航 -->
...
import CascadeUserManageList from './pages/CascadeUserManageList'
import CascadeUserManageSearch from './pages/CascadeUserManageSearch'

export default {
  name: 'CascadeUserManage',
  components: {
    CascadeUserManageList,
    CascadeUserManageSearch
  },
  data() {
    return {
      ...
      menus: [
        {
          index: 'CascadeUserManage',
          title: '级联用户管理',
          items: [
            {
              index: 'CascadeUserManageList',
              title: '列表'
            },
            {
              index: 'CascadeUserManageSearch',
              title: '查询'
            }
          ]
        }
