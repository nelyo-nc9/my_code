<template>
    <div class="onlineTime-box" ref='onlineTimeBox' @wheel.stop="scrollFunc" @click.stop="mouseUp" @mousemove.stop="mouseMove" @mouseup.stop="mouseUp" @mouseleave.stop="mouseUp">
