  ...
  data() {
    return {
      ...
      tableColumn: [
        ...
        { prop: 'netModuleModel', label: '工程商', width: '100', sortable: true },
        { prop: 'netModuleID', label: '维保商', width: '100', sortable: true },
        { prop: 'keyboardPassword', label: '维修人', width: '100', sortable: true },
        { prop: 'ip', label: '维修人电话', width: '130', sortable: true },
        { prop: 'port', label: '发现时间', width: '100', sortable: true },
        { prop: 'userName', label: '发现人', width: '100', sortable: true },
        { prop: 'password', label: '申报类型', width: '100', sortable: true },
        { prop: 'service', label: '申报原因', width: '100', sortable: true },
        { prop: 'port', label: '故障来源', width: '100', sortable: true },
        { prop: 'userName', label: '故障类型', width: '100', sortable: true },
        { prop: 'password', label: '故障状态', width: '100', sortable: true },
        { prop: 'service', label: '处理时间', width: '100', sortable: true },
        { prop: 'password', label: '故障处理时长', width: '130', sortable: true },
        { prop: 'service', label: '故障备注', width: '100', sortable: true }
      ],
      tableData: [
        // 列表数据
      ],
