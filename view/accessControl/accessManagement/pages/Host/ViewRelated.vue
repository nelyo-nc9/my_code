<template>
  <div id="viewRealted">
    ...
    <div ref="printJS_container" id="printJS_container" style="overflow:auto">
      <div class="tableView">
        <div class="tableList">
          <ul>
        ...
        <el-collapse v-model="activeNames" @change="collEvent">
          <el-collapse-item title="关联视频通道列表" name="1">
            <el-table :data="audio"  border style="width: 100%">
              ...
              <!-- <el-table-column prop="address" label="视频通道类型"></el-table-column> -->
          ...
          <el-collapse-item title="关联对讲通道列表" name="2">
            <el-table :data="video"  border style="width: 100%">
              ...
              <!-- <el-table-column prop="serise" label="对讲通道号"></el-table-column> -->
              <!-- <el-table-column prop="uniqueId" label="对讲通道ID"></el-table-column> -->
          ...
          <el-collapse-item title="关联输出通道列表" name="4">
            <el-table :data="output"  border style="width: 100%">
              ...
              <!-- <el-table-column prop="serise" label="状态"></el-table-column> -->
              <el-table-column prop="brand" label="品牌"></el-table-column>
              <el-table-column prop="modelNum" label="型号"></el-table-column>
              <el-table-column prop="assetCode" label="资产编码"></el-table-column>
            </el-table>
...
export default {
  components: {
    ...
    Topology: () => import('@src/view/accessControl/accessManagement/components/Topology'),
    userInfo: () => import('@src/view/accessControl/components/userInfo.vue'),
    Gplot,
  },
  props: ['childTbaList', 'tableItem', 'migra', 'configurationdata', 'selectedData', 'hostInfo', 'info'],
  ...
  methods: {
    ...
    getGanGedList() {
      // let { id } = this.migra
      // getGanged(`/resource/v1/guard/linkage/${id}`, {
      //   ref: 1
      // }).then(res => {
      //   console.log('Log查看指定主机下配置列表数据 ', res.data.data)
  ...
  mounted() {
    ...
    getHostOrControlLinkages(`/resource/v1/guard/linkage/${this.hostInfo.id}`, params).then((res) => {
      console.log('Log 查看关联的主机数据', res.data.data)
