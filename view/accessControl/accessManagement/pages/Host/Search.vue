    ...
    <div class="deviceCon" style="height:100%">
                ...
                <div class="form-content">
                  <el-form ref="searchModel" :model="formInline" :rules="rules">
                    ...
                    <el-form-item label="门禁主机类型">
                      <el-select v-model="formInline.type" placeholder="请选择门禁主机类型" size="mini">
                        <el-option
                    ...
                    <el-form-item label="门禁主机名称" prop="name">
                      <el-input v-model="formInline.name" placeholder="请输入主机名称"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="品牌">
                      ...
                      <!-- <el-select v-model="formInline.brand"  placeholder="请输入品牌" size="mini">
                        <el-option
                    ...
                    <el-form-item label="型号">
                      ...
                      <!-- <el-select v-model="formInline.modelNum" placeholder="请输入型号" size="mini">
                        <el-option
      ...
      <div class="deviceTable" style="padding:10px">
        ...
        >
          ...
          <!-- <el-table-column prop="subSystemName" label="所属子系统"></el-table-column> -->
          ...
          <el-table-column
            ...
            sortable
          ></el-table-column>
          <el-table-column width="120" show-overflow-tooltip prop label="门禁主机类型" sortable>
          ...
          <el-table-column width="80" show-overflow-tooltip label="在线状态" sortable>
            <template slot-scope="scope">
              <span v-show="scope.row.status == 1">离线</span>
              <span v-show="scope.row.status == 2">在线</span>
            </template>
          </el-table-column>
          <!-- <el-table-column prop="updatedBy" label="录入人" sortable></el-table-column>
          <el-table-column prop="updatedDept" label="录入机构" sortable></el-table-column>
          <el-table-column prop="updatedAt" label="录入时间" width="200" sortable></el-table-column>-->
        </el-table>
        <div class="block">
          <video-pagination
            ref="listPagination"
  ...
  methods: {
    ...
    exportClick() {
      if (this.serchDerive && this.serchDerive.length > 0) {
        ...
        if (this.AslieSearchTimer) {
          clearTimeout(this.AslieSearchTimer)
        }
     let result = this.deleteObjKey(this.formInline)
      ...
      delete SearchObj.keyPartName
        ...
        this.AslieSearchTimer = setTimeout(() => {
          let body = {
            pattern: 'inquery',
    ...
    inquireClick(typeP, pageChange) {
      ...
      this.timer = setTimeout(() => {
        getAccessCommonList(body)
          .then((data) => {
            // getPlatformList({page:1,limit:100,rescusive:false}).then(data=>{
            console.log(data)
