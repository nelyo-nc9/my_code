    ...
    <div class="deviceCon" style="height:100%">
              ...
              <div class="alarm-log-inquire">
                <div class="form-content">
                  <el-form ref="searchModel" :model="formInline" :rules="rules">
                    ...
                    <el-form-item label="报警输入名称" prop="name">
                      <el-input v-model="formInline.name" placeholder="请输入报警输入名称"></el-input>
                    </el-form-item>
                    <el-form-item label="资产编码">
                      <el-input v-model="formInline.assetcode" placeholder="请输入资产编码"></el-input>
                    </el-form-item>
                    <el-form-item label="报警输入ID" prop="uniqueId">
                      <el-input size="mini" v-model="formInline.uniqueId" placeholder="请输入报警输入ID"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="品牌">
                      <el-input size="mini" v-model="formInline.brand" placeholder="请输入品牌"></el-input>
                    ...
                    <el-form-item label="型号">
                      <el-input size="mini" v-model="formInline.modelNum" placeholder="请输入型号"></el-input>
      ...
      <div class="deviceTable" style="padding:10px">
        ...
        >
          ...
          <el-table-column sortable width="120" show-overflow-tooltip prop="orgName" label="所属机构"></el-table-column>
          <el-table-column
            sortable
            width="120"
          ...
          <el-table-column
            ...
            label="报警输入ID"
          ></el-table-column>
          <el-table-column sortable width="120" show-overflow-tooltip prop="brand" label="品牌"></el-table-column>
          <el-table-column sortable width="120" show-overflow-tooltip prop="modelNum" label="型号"></el-table-column>
          <el-table-column sortable width="120" show-overflow-tooltip label="关联摄像头">
            <template slot-scope="scope">
              <span v-if="scope.row.isVideoLink == 2">已关联</span>
              <span v-else>未关联</span>
            </template>
          </el-table-column>
          <el-table-column sortable show-overflow-tooltip width="120" label="关联对讲通道">
            <template slot-scope="scope">
              <span v-if="scope.row.isAudioLink == 2">已关联</span>
              <span v-else>未关联</span>
            </template>
          </el-table-column>
          <el-table-column sortable show-overflow-tooltip width="120" label="关联门禁通道">
            <template slot-scope="scope">
              <span v-if="scope.row.isGuardLink == 2">已关联</span>
              <span v-else>未关联</span>
            </template>
          </el-table-column>
          <el-table-column sortable show-overflow-tooltip label="关联输出通道" width="120">
            <template slot-scope="scope">
          ...
          <el-table-column
            ...
            label="资产编码"
          ></el-table-column>
          <el-table-column sortable width="120" show-overflow-tooltip label="状态">
            <template slot-scope="scope">
...
export default {
  ...
  mounted() {
    ...
    //门禁主机品牌
    let hostBrands = [{ type: '1', moduleId: '1', childModuleId: '4', dictId: '16' }]
  ...
  methods: {
    ...
    changeBrans(index) {
      ...
      // 新建门禁主机型号
      let hostModelNumsTypea = [{ type: '1', moduleId: '1', childModuleId: '4', dictId: '17' }]
    ...
    exportClick() {
      if (this.serchDerive && this.serchDerive.length > 0) {
        ...
        export_json_to_excel(tHeader, data, '门禁报警输入')
      } else {
        if (this.SearchTimer) {
      ...
      delete SearchObj.keyPartName
          ...
          let name = `门禁报警输入导出${this.$moment(new Date()).format('YYYY-MM-DD HH-mm-ss')}.xlsx`
          download(
            url,
            name,
            () => {},
    ...
    inquireClick(typeP, pageChange) {
     if (this.endTime !== '' && this.endTime !== null) {
      ...
      delete SearchObj.orgName
      delete SearchObj.keyPartName
      SearchObj.type = 3 // 只查询报警输入通道 type为3
      let body = {
        page: this.currpage,
        limit: this.pageSize,
