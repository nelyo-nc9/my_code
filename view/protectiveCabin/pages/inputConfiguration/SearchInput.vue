    ...
    <div class="content">
      <div class="header">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>报警输入设备配置</el-breadcrumb-item>
      ...
      <div class="query-form">
        ...
        <div class="form-content"
          ...
          <el-form ref="searchModel"
            ...
            <el-form-item label="报警输入通道"
                          prop='name'>
              <el-input v-model="searchModel.name"
                        placeholder="请输入报警输入通道名称"></el-input>
            </el-form-item>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { prop: 'name', sortable: true, label: '报警输入名称', width: '160' },
        { prop: 'serise', sortable: true, label: '报警输入号', width: '140' },
        { prop: 'isVideoLink', label: '关联摄像头', width: '140px', sortable: 'true' },
      ...
      rules: rules.inputConfiguration,
    }
  },
  methods: {
    //隐藏输入框
