...
import { getResourceInfoApi, getLocOrOrgInfoApi, getIpIspingApi } from '@src/http/video/videoConfig.api.js'
import { listInfoApi } from '@src/http/protectiveCabin/channe.api.js'
