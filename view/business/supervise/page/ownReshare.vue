     ...
     <div class="top-box">
        <header>
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>本级资源共享</el-breadcrumb-item>
          </el-breadcrumb>
        </header>
      </div>
      <div class="main">
        ...
        <div class="content-box">
           ...
           <div class="button-box">
              <div class="check" style="margin-top:180px;margin-left:5px">
                 <el-checkbox v-model="checked">现场视频</el-checkbox>
                 <el-checkbox v-model="checked" style="margin-top:10px">录像回放</el-checkbox>
                 <el-checkbox v-model="checked" style="margin-top:10px">下载</el-checkbox>
              </div>
           ...
           <div class="right-content-box">
              <div class="top">
                <el-checkbox v-model="checked" >全部</el-checkbox>
                 <el-checkbox v-model="checked">现在</el-checkbox>
                 <el-checkbox v-model="checked">回放</el-checkbox>
                 <el-checkbox v-model="checked">下载</el-checkbox>
                 <el-button style="width:70px;height:30px;line-height: 8px;">保存</el-button>
              </div>
              <div class="tree-box">
                <div class="tree-top">
                  <h3>已共享资源</h3>
