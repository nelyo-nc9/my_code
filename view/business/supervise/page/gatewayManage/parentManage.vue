    ...
    <div class="top-box">
        <header>
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>上级域配置</el-breadcrumb-item>
      ...
      <div class="main" v-show="isList">
        ...
        <edit v-if="isEdit" :back='close' :talklist='talklist' :editNum='editnumber'></edit>
...
export default {
  ...
  data() {
    return {
       ...
       title:"列表",
       columns: [
        { prop: 'orgName', sortable: false, label: '上级域名称', width: '130', sortable: true },
        { prop: 'subCode', sortable: false, label: '上级域编号', width: '130', sortable: true },
        { prop: 'ip', sortable: false, label: '上级域ip地址', width: '170', sortable: true },
        { prop: 'port', sortable: false, label: '上级域端口', width: '150', sortable: true },
  ...
  methods: {
    ...
    Toprint() {
      ...
      printJS({
        ...
        properties: [
          { field: 'orgName', displayName: '上级域名称' },
          { field: 'subCode', displayName: '上级域编号' },
          { field: 'ip', displayName: '上级域ip地址' },
          { field: 'port', displayName: '上级域端口' },
