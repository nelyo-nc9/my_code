  ...
  <div>
    ...
    <div class="nav">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>信访平台配置</el-breadcrumb-item>
    ...
    <div class="message-container">
      ...
      <div class="message-set-wrap" v-show="!is_edit">
        ...
        <el-button plain v-print="'#contentinfo'">打印</el-button>
      </div>
      <div id="contentinfo" style="width:1050px;">
        <p class="message-set-title">目标RSSM</p>
        <!-- 信访平台配置 信息 -->
        <div class="message-set-content">
          ...
          <div class="message-set-item">
            <div class="message-set-label">启用信访推送</div>
