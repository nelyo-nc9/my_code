<template>
  <div class="org-manage-create-modify-box">
    ...
    <el-button size="small" @click="dialogTableVisible = true">查看流程</el-button>
    ...
    <div class="content">
      <div class="main" id="contentinfo">
        <div class="main-box" ref="printJS_people" id="printJS_people">
          <div class="box-title">访客入园申请单</div>
          <div class="main-box-center">
            ...
            <table cellspacing="0" cellpadding="0">
              <tr style="height:100px">
                <td class="box-cell-title" rowspan="9">
                  <span>访客信息</span>
                </td>
                <td class="box-cell-title">
                  <span>访客照片</span>
              ...
              <tr>
                ...
                <td class="box-cell-title" v-for="(item,i) in peopleList" :key="i">
                  <el-input v-model="item.startTime" disabled></el-input>
                </td>
              </tr>
              <tr>
                <td class="box-cell-title">
                ...
                <td class="box-cell-title" v-for="(item,i) in peopleList" :key="i">
                  <el-input v-model="item.overTime" disabled></el-input>
                </td>
              </tr>
              ...
              <tr>
                <td class="box-cell-title">注意事项</td>
                <td class="box-cell-input" colspan="6">
                  <el-input v-model="formData.applyPeople" disabled></el-input>
                </td>
              </tr>
              <tr>
                <td class="box-cell-title">附件</td>
                <td class="box-cell-input" align="center" colspan="6">
    ...
    <!-- 查看流程弹框 -->
    <el-dialog title="流程视图" :visible.sync="dialogTableVisible">
      <el-table :data="gridData">
        <el-table-column prop="index" label="序号" width="50"></el-table-column>
        <el-table-column property="date" label="操作日期"></el-table-column>
        <el-table-column property="name" label="操作内容"></el-table-column>
        <el-table-column property="date" label="操作人"></el-table-column>
        <el-table-column property="name" label="操作记录"></el-table-column>
        <el-table-column property="address" label="发送时间"></el-table-column>
      </el-table>
    </el-dialog>
  </div>
</template>
