    ...
    <div class="content">
      <div class="main" id="contentinfo">
        <div class="main-box" ref="printJS_people" id="printJS_people">
          <div class="box-title">审批访客入园申请单</div>
          <div class="main-box-center">
            ...
            <table cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td class="box-cell-input" colspan="5">
                  <el-input type="textarea" v-model="formData.articlesFile" maxlength="500" disabled></el-input>
                </td>
              </tr>
              <tr>
            ...
            <div class="content-bottom">
              <el-button size="small" @click="submit">同意</el-button>
              <el-button size="small" @click="dialogVisible = true">取消</el-button>
              <el-button size="small" @click="deposit">驳回</el-button>
            </div>
            <table cellspacing="0" cellpadding="0">
              <tr>
