        ...
        <div class="main-box">
          ...
          <div class="main-box-center">
            <table cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="box-cell-title" :rowspan="carList.length+1">
                  <span>车辆信息</span>
                </td>
                <td class="box-cell-title">
                  <span>车牌号</span>
            ...
            <table cellspacing="0" cellpadding="0">
              ...
              <tr v-for="(item,index) in reviseList" :key="index+2">
                <td class="box-cell-input" align="center" maxlength="20">
                  <el-input v-model="item.reviseMent" disabled maxlength="200"></el-input>
                </td>
                <td class="box-cell-input" align="center" maxlength="20">
                  <el-input v-model="item.reviseChild" disabled maxlength="200"></el-input>
                </td>
                <td class="box-cell-input" align="center" maxlength="10">
                  <el-input v-model="item.reviseName" disabled maxlength="200"></el-input>
                </td>
                <td class="box-cell-input" align="center">
                  <el-input v-model="item.reviseTime" disabled maxlength="200"></el-input>
                </td>
                <td class="box-cell-input" align="center" maxlength="20">
                  <el-input v-model="item.reviseStatus" disabled maxlength="200"></el-input>
                </td>
                <td class="box-cell-input" align="center" show-overflow-tooltip maxlength="200">
                  <el-input v-model="item.reviseMsg" disabled maxlength="200"></el-input>
                </td>
              </tr>
            </table>
          </div>
...
export default {
  ...
  methods: {
    infos() {
      ...
      this.formData.keyPartsName = this.infoObj.orgName
      this.formData.applyNumber = this.infoObj.orgName
      this.formData.applyPeople = this.infoObj.orgName
      this.formData.applyDepartment = this.infoObj.orgName
    },
