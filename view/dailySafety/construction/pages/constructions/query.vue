            ...
            <ul>
             <li>
              ...
              <li>
                <span>施工区域</span>
                <section>
                  <el-input v-model="formData.region" size="small" clearable></el-input>
                </section>
              </li>
              <li>
                <span>施工类型</span>
