<template>
  <div class="main">
    ...
    <div style="margin:20px 0;">
      ...
      <el-button style="font-size:12px;" plain @click="exportFile('施工巡查记录列表')">导出</el-button>
      <el-button style="font-size:12px;" plain @click="Toprint('施工巡查记录列表')">打印</el-button>
    </div>
    <div>
      <el-table
        :data="tableData"
  ...
  data() {
    return {
      ...
      tableColumn: [
        ...
        { prop: 'date', label: '单号', width: '', sortable: 'true' },
        { prop: 'date', label: '施工单位', width: '', sortable: 'true' },
        { prop: 'name', label: '施工区域', width: '', sortable: 'true' },
        { prop: 'date', label: '施工类型', width: '', sortable: 'true' },
        { prop: 'name', label: '巡查时间', width: '', sortable: 'true' },
        { prop: 'date', label: '巡查备注信息', width: '', sortable: 'true' },
        { prop: 'name', label: '巡查人', width: '', sortable: 'true' },
        { prop: 'date', label: '附件', width: '', sortable: 'true' }
      ],
    ...
    Toprint(title) {
      ...
      printJS({
        ...
        properties: [
          ...
          { field: 'name', displayName: '单号' },
          { field: 'date', displayName: '施工单位' },
          { field: 'name', displayName: '施工区域' },
          { field: 'date', displayName: '施工类型' },
          { field: 'name', displayName: '巡查时间' },
          { field: 'date', displayName: '巡查备注信息' },
          { field: 'name', displayName: '巡查人' },
          { field: 'date', displayName: '附件' }
        ],
        type: 'json',
        // 表题
