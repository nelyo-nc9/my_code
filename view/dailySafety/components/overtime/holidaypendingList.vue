        ...
        >
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              <div>
                <el-link :underline="false" @click="handleApproval('审批', scope.row)">审批</el-link>
              </div>
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        { prop: 'mechanism', sortable: true, label: '录入人', width: '' },
