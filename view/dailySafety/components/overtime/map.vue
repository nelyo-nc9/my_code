...
import MapApp from '@src/view/map2D/baseMap/MapApp'
import { PanelSearch, PanelSwitch, PanelWarning } from '@src/view/map2D/panelSearch'
import { EMapTools, Tools } from '@src/view/map2D/panelTool'
import PanelInfo from '@src/view/map2D/panelInfo/PanelInfo'
import BoxSelectStatistic from '@src/view/map2D/panelInfo/BoxSelectStatistic'
import RealtionEquipment from '@src/view/map2D/panelInfo/RealtionEquipment'
import WeatherList from '@src/view/map2D/panelTool/WeatherList'
import DistrictSetting from '@src/view/map2D/panelInfo/panel/DistrictSetting'
import PanelDistrict from '@src/view/map2D/panelInfo/panel/PanelDistrict'
import PanelInfoImport from '@src/view/map2D/panelInfo/panel/PanelInfoImport'
export default {
  name: 'map2d',
  components: {
    MapApp,
