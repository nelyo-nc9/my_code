  ...
  <div class="org-manage-create-modify-box">
    ...
    <div class="content">
      ...
      <div class="content-bottom">
        ...
        <el-button style="font-size:12px;" plain @click="exportFile('危险品核查记录查询统计表')"
          ...
          <div style="min-height:400px;">
            ...
            >
              ...
              <el-table-column
                ...
                show-overflow-tooltip
              ></el-table-column>
              <el-table-column prop="address" label="附件" min-width="70">
