<template>
  <div class="main">
    ...
    <div style="margin:20px 0;" v-show="isShowInfo==false">
      ...
      <el-button style="font-size:12px;" plain @click="exportFile('自然灾害信息管理')">导出</el-button>
      <el-button style="font-size:12px;" plain @click="Toprint('自然灾害信息管理')">打印</el-button>
    </div>
  ...
  methods: {
    ...
    Toprint(title) {
      ...
      printJS({
        ...
        properties: [
          { field: 'orgName', displayName: '灾害名称' },
          { field: 'date', displayName: '事发机构' },
          { field: 'name', displayName: '事发时间' },
          { field: 'name', displayName: '灾害类别' },
          { field: 'name', displayName: '灾害等级' },
          { field: 'name', displayName: '受影响部位数' },
          { field: 'name', displayName: '停业部位数' },
          { field: 'name', displayName: '受伤人数' },
          { field: 'name', displayName: '伤亡人数' },
          { field: 'name', displayName: '损失金额(万元)' },
          { field: 'name', displayName: '损失设备数' }
        ],
        type: 'json',
        // 表题
