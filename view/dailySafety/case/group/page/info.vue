    ...
    <div class="content">
      <div class="main" id="contentinfo">
        <div class="main-box" ref="printJS_people" id="printJS_people">
          <div class="box-title">安全事故信息管理信息表</div>
          <div class="main-box-center">
            <table cellspacing="0" cellpadding="0">
              <tr>
                <td class="box-cell-title" colspan="2">
                  <span style="width:100%">事故名称</span>
                </td>
              ...
              <tr>
                ...
                <td class="box-cell-input" colspan="2">
                  <el-select
                    v-model="formData.keyPartsName"
                    placeholder="请选择安全事故类别"
                    style="width: 100%;"
                     disabled
                  >
                    <el-option value="安全事故类别1"></el-option>
                    <el-option value="安全事故类别2"></el-option>
                  </el-select>
                </td>
                <td class="box-cell-title" colspan="2">
                  <span>事故级别</span>
                ...
                <td class="box-cell-input" colspan="2">
                  <el-select
                    ...
                    style="width: 100%;"
                     disabled
                  >
                    <el-option value="事故级别1"></el-option>
                    <el-option value="事故级别2"></el-option>
                  </el-select>
                </td>
              </tr>
              <tr>
