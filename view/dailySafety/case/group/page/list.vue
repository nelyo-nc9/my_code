<template>
  <div class="main">
    ...
    <div style="margin:20px 0;" v-show="isShowInfo==false">
      ...
      <el-button style="font-size:12px;" plain @click="exportFile('群体性事件管理')">导出</el-button>
      <el-button style="font-size:12px;" plain @click="Toprint('群体性事件管理')">打印</el-button>
    </div>
    ...
    Toprint(title) {
      ...
      printJS({
        ...
        properties: [
          ...
          { field: 'date', displayName: '发生时间' },
          { field: 'name', displayName: '发生机构' },
          { field: 'name', displayName: '发生地点' },
          { field: 'name', displayName: '时间种类' },
          { field: 'name', displayName: '总人数' },
          { field: 'name', displayName: '及时劝返总人数' },
          { field: 'name', displayName: '由过激行为总人数' },
          { field: 'name', displayName: '缠访总人数' },
          { field: 'name', displayName: '录入机构' },
          { field: 'name', displayName: '录入人' },
          { field: 'name', displayName: '录入时间' }
        ],
        type: 'json',
        // 表题
