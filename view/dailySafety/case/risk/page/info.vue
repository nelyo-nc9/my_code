    ...
    <div class="content">
      <div class="main" id="contentinfo">
        <div class="main-box" ref="printJS_people" id="printJS_people">
          <div class="box-title">案(事)件及风险事件信息表</div>
          <div class="main-box-center">
            <table cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td class="box-cell-input">
                  <el-select v-model="formData.keyPartsName" placeholder="请选择案(事)件类别" disabled>
                    <el-option value="案(事)件类别1"></el-option>
                    <el-option value="案(事)件类别2"></el-option>
                  </el-select>
                </td>
              </tr>
              <tr>
                ...
                <td class="box-cell-input">
                  <el-select v-model="formData.keyPartsName" placeholder="案(事)件级别" disabled>
                    <el-option value="案(事)件级别1"></el-option>
                    <el-option value="案(事)件级别2"></el-option>
                  </el-select>
                </td>
                <td class="box-cell-title">
                  <span>案(事)件分类</span>
                ...
                <td class="box-cell-input">
                  <el-select v-model="formData.keyPartsName" placeholder="案(事)件分类" disabled>
                    <el-option value="案(事)件分类1"></el-option>
                    <el-option value="案(事)件分类2"></el-option>
                  </el-select>
                </td>
                <td class="box-cell-title">
                  <span>涉案事项</span>
                ...
                <td class="box-cell-input">
                  <el-select v-model="formData.keyPartsName" placeholder="涉案事项" disabled>
              ...
              <tr>
                ...
                <td class="box-cell-input">
                  <el-input v-model="formData.orgName" placeholder="最少" disabled></el-input>
                </td>
                <td class="box-cell-input">
                  <el-input v-model="formData.orgName" placeholder="最多" disabled></el-input>
                </td>
                <td class="box-cell-title">
                  <span>挽回损失(万元)</span>
                </td>
              ...
              <tr>
                ...
                <td class="box-cell-input">
                  <el-select v-model="formData.keyPartsName" placeholder="是否被媒体报道" disabled>
                    <el-option value="是否被媒体报道1"></el-option>
                    <el-option value="是否被媒体报道2"></el-option>
                  </el-select>
                </td>
                <td class="box-cell-title" colspan="2">
                  <span>监管部门是否知情</span>
                ...
                <td class="box-cell-input">
                  <el-select v-model="formData.keyPartsName" placeholder="监管部门是否知情" disabled>
                    <el-option value="监管部门是否知情1"></el-option>
                    <el-option value="监管部门是否知情2"></el-option>
                  </el-select>
                </td>
              </tr>
              <tr>
